            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('company.register') }}">
                        ...
                        <div class="form-group row">
                            <label for="nearest_station" class="col-md-4 col-form-label text-md-right">最寄り駅</label>

                            <div class="col-md-6">
                                <input id="nearest_station" type="text" class="form-control @error('nearest_station') is-invalid @enderror" name="nearest_station" value="{{ old('nearest_station') }}" required autocomplete="nearest_station" autofocus>
